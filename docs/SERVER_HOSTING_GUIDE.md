...
DECIDERO_LOGIN_RATE_LIMIT_ENABLED=true
DECIDERO_LOGIN_RATE_LIMIT_MAX_FAILURES_PER_USERNAME=8
DECIDERO_LOGIN_RATE_LIMIT_MAX_FAILURES_PER_IP=40
DECIDERO_LOGIN_RATE_LIMIT_WINDOW_SECONDS=60
DECIDERO_LOGIN_RATE_LIMIT_LOCKOUT_SECONDS=60
GRAB_ENABLED=false
LOG_LEVEL=INFO
