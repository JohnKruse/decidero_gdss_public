...
`sequence` round subcycle: rank first, then an in-round facilitator decision (how
many least-converged ideas to open for comment), then a comment step. The comment
step is the *generic* brainstorming activity configured as a comment surface — no
bespoke activity. The ranking carries the prior round's feedback (`↩ feedback`) and
is the target of the dashed loop-back, gated by the facilitator at each round
boundary.
...
flowchart TD
    subgraph c0["Sequence"]
        ...
        subgraph c0_1["Iterate · ≤4 rounds · converge: iqr_stability · transform: delphi_statistical_aggregation · gate: facilitator decision / report: delphi_round_agreement→facilitator / recommends via rule"]
            ...
            subgraph c0_1_0["Sequence (subcycle)"]
                ...
                n0_1_0_1{"How many least-agreed ideas to open for comment?<br/><small>facilitator decision</small><br/><small>report: delphi_round_agreement→facilitator</small>"}
                n0_1_0_2["Comment on Disputed Ideas<br/><small>brainstorming</small>"]
            end
        end
    end
    ...
    n0_1_0_0 --> n0_1_0_1
    n0_1_0_1 --> n0_1_0_2
    n0_1_0_2 -. "continue · facilitator gate" .-> n0_1_0_0
    n0_0 --> n0_1_0_0
```
